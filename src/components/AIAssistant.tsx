...
export function AIAssistant({ isPenguine }: AIAssistantProps) {
  ...
  useEffect(() => {
    ...
    const handlePointerMove = (e: PointerEvent) => {
      ...
      const targetEl =
        dragStateRef.current.type === "bubble"
          ? bubbleRef.current
          : windowRef.current;
      if (!targetEl) return;
    ...
    <>
      ...
      {!isOpen && (
        ...
        >
          ...
          <BlueskyIcon
            ...
            className="relative z-10 transition-transform group-hover:scale-110 text-[var(--primary-content)]"
            strokeWidth={1.5}
          />
        </button>
      )}
      ...
      {isOpen && (
        <div
          ...
          style={{
            left: isMobile
              ...
              : isTablet
                ...
                : showConfig
                  ? "auto"
                  : `${position.x}px`,
            right: isTablet ? "24px" : showConfig ? "24px" : "auto",
            top: isMobile
              ? "auto"
              : isTablet
                ? "auto"
            ...
            transition:
              isMobile && isSheetDragging ? "none" : "transform 0.25s ease",
        ...
        >
                ...
                {isMinimized ? (
                  ...
                  >
                    <path
                      ...
                      d="M4 8v8m0 0l4-4m-4 4l-4-4m16 0v8m0 0l-4-4m4 4l4-4"
                    />
                  </svg>
                ) : (
                  <svg
                  ...
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M20 4v8m0 0l-4-4m4 4l4-4M4 20v-8m0 0l4 4m-4-4l-4 4"
                    />
                  </svg>
                )}
              </button>
          ...
          {!isMinimized && (
            <>
              {/* Messages */}
              <div className="ai-messages-container flex-1 overflow-y-auto px-4 py-4 space-y-3 bg-transparent">
                {!messages.length && (
                  <div className="ai-empty-state flex flex-col items-center justify-center h-full text-center py-8 relative overflow-hidden">
                    ...
                    <div className="w-16 h-16 bg-white dark:bg-[var(--surface)] rounded-2xl flex items-center justify-center mb-4 shadow-lg overflow-hidden border-2 border-[var(--primary)]/20 text-[var(--primary)]">
                      <BlueskyIcon size={40} />
                    </div>
                  ...
                  >
                    <div
                      className={`max-w-[80%] px-3.5 py-2.5 rounded-2xl text-sm leading-relaxed ${
                        msg.role === "user"
                          ? "bg-[var(--primary)] text-[var(--primary-content)] rounded-br-sm shadow-md"
                          : "bg-white dark:bg-[var(--surface)] text-[var(--text)] rounded-bl-sm border border-[var(--primary-light)] dark:border-[var(--border)] shadow-sm"
                      }`}
                    >
                ...
                {isLoading && (
                  <div className="flex justify-start">
                    <div className="bg-white dark:bg-[var(--surface)] px-4 py-3 rounded-2xl rounded-bl-sm border border-[var(--primary-light)] dark:border-[var(--border)] shadow-sm">
                      <div className="flex gap-1.5">
                        <span
                          className="w-1.5 h-1.5 bg-[var(--primary)]/60 rounded-full animate-bounce"
      ...
      {showConfig && (
        <div
          className={
            isCompact
              ? "fixed inset-0 bg-black/45 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-4 z-[220]"
              : "fixed top-[88px] left-4 right-[408px] z-[105] pointer-events-none flex items-start justify-end"
          }
        >
          <div
            className={
          ...
          >
            ...
            <div className="px-5 py-4 space-y-4 overflow-y-auto flex-1">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setDraftConfig({ ...draftConfig, name: e.target.value })
                  }
              ...
              <div>
                ...
                <p className="text-xs text-[var(--text-muted)] mt-1">
                  Define the assistant's personality, tone, and areas of
                  expertise.
                </p>
              </div>
                ...
                <div className="flex gap-2">
                  {Object.entries({
                    ...
                    <button
                      key={color}
                      onClick={() =>
                        setDraftConfig({ ...draftConfig, accentColor: color })
                      }
                      className={`w-8 h-8 rounded-full ${cls} transition-all ${
                        draftConfig.accentColor === color
                          ? "ring-2 ring-offset-2 ring-[var(--border-strong)] scale-110"
                          : ""
                      }`}
                    />
                  ))}
                  ...
                  {[
                    {
                      ...
                      systemPrompt:
                        "You are a supportive wellness coach specializing in menstrual health and cycle tracking. Provide evidence-based advice, be empathetic, and always recommend consulting healthcare providers for medical concerns. Keep responses concise and actionable.",
                      accentColor: "cyan",
                    },
                    {
                      name: "Study Buddy",
                      ...
                      systemPrompt:
                        "You are a knowledgeable academic assistant who can help with math, science, and other subjects. Explain concepts clearly with step-by-step breakdowns. Be encouraging and patient.",
                      accentColor: "amber",
                    },
                    {
                      ...
                      systemPrompt:
                        "You are a calm, supportive mindfulness guide focused on mental wellness, stress management, and emotional support. Offer practical techniques for relaxation, meditation, and emotional regulation. Be gentle and non-judgmental.",
                      accentColor: "violet",
                    },
                    {
                      ...
                      systemPrompt:
                        "You are a nutrition advisor who provides practical dietary advice tailored to menstrual health and overall wellbeing. Suggest foods that support hormonal balance and energy levels. Always recommend consulting a dietitian for personalized plans.",
                      accentColor: "rose",
                    },
                  ].map((preset) => (
                    <button
                      ...
                      className="p-3 text-left border border-[var(--border)] bg-white/50 dark:bg-black/20 rounded-xl hover:border-[var(--primary)] hover:bg-[var(--primary)]/10 transition-all"
                    >
            ...
            <div className="flex gap-3 px-5 py-4 border-t border-[var(--border)]">
              ...
              <button
                ...
                className="flex-1 py-2.5 bg-[var(--primary)] text-[var(--primary-content)] rounded-xl text-sm font-medium hover:bg-[var(--primary-hover)] transition-colors"
              >
                Apply
              </button>
            </div>
